...
\*With useRef Hook we can crate a reference to a ReactNode, but also to create a
reference to an specific value, and the main thing is that when we update that
