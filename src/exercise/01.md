...
\*Each time you call the updater function from useState, you rerender your
component. Why?. Because thats the way react forces to the component to update
its state with the new value you just set.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=01%3A%20useState%3A%20greeting&em=agustin.moranr%40gmail.com).
